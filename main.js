...
function addProjectClickHandler() {
    ...
    let projects = _ProjectClass_js__WEBPACK_IMPORTED_MODULE_0__.ProjectList.projects
    ...
    // add to project list
    _ProjectClass_js__WEBPACK_IMPORTED_MODULE_0__.ProjectList.add(new _ProjectClass_js__WEBPACK_IMPORTED_MODULE_0__.Project(name))

    // save to local storage
    ;(0,_index_js__WEBPACK_IMPORTED_MODULE_2__.saveToLocalStorage)()
...
/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./display.js */ "./src/display.js");
/* harmony import */ var _ProjectClass_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ProjectClass.js */ "./src/ProjectClass.js");
...
function addTaskClickHandler() {
    ...
    // create new Task
    let task = new _TaskClass_js__WEBPACK_IMPORTED_MODULE_0__.Task(taskName, dueDate, false, priority);

    // add new task to current project
    (0,_ProjectClass_js__WEBPACK_IMPORTED_MODULE_2__.getActiveProject)().addTask(task);

    // update local storage
    (0,_index_js__WEBPACK_IMPORTED_MODULE_3__.saveToLocalStorage)();
...
/* harmony import */ var _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProjectClass.js */ "./src/ProjectClass.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/format/index.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.js */ "./src/index.js");
/* harmony import */ var _sort_tasks_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sort-tasks.js */ "./src/sort-tasks.js");
...
function updateProjects() {
    ...
    (0,_index_js__WEBPACK_IMPORTED_MODULE_2__.loadLocalStorage)() 

    // get list of projects
    let projects = _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.projects
...
function createProjectDiv(projectName) {
    let name = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('title', projectName)
    ...
    let iconContainer = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('delete-icon')
    iconContainer.appendChild(closeIcon)

    let element = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('project')
...
function setActiveProject(e) {
    if (!e.target.className.includes('close')) {
        (0,_ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.getActiveProject)().toggleActive()
        ...
        let index = _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.projects.map(proj => proj.name).indexOf(next)
        _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.projects[index].active = true
...
function removeProject(e) {
    ...
    _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.remove(projectName)
...
function updateTasks() {
    ...
    projectTitle.textContent = (0,_ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.getActiveProject)().name

    let tasks = (0,_ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.getTasksOfActiveProject)()
...
function createTaskDiv(task) {
    let checkbox = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('checkbox')
    let icon = createTaskRadioButton(task)
    checkbox.append(icon)

    let title = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('title', task.title)
    let taskID = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('task-id', task.id)

    let due = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('due-date')
    ...
    let del = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('delete')
    let closeIcon = createTaskDeleteButton()
    del.append(closeIcon)
    del.addEventListener('click', removeTask)

    let element = (0,_add_task_js__WEBPACK_IMPORTED_MODULE_0__.createDiv)('task')
...
function removeTask(e) {
    ...
    ;(0,_ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.getActiveProject)().removeTask(taskID)
...
function completeTask(e) {
    ...
    let index = (0,_ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.getTasksOfActiveProject)().map(task => task.id).indexOf(taskID)
    ;(0,_ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.getTasksOfActiveProject)()[index].toggleComplete()
...
function sortTasks() {
    ...
    switch (sortBy) {
        case 'date':
            ;(0,_sort_tasks_js__WEBPACK_IMPORTED_MODULE_3__.sortTasksByDueDate)(tasks, order)
            break;
        case 'priority':
            (0,_sort_tasks_js__WEBPACK_IMPORTED_MODULE_3__.sortTasksByPriority)(tasks, order)
            break;
        case 'name':
            (0,_sort_tasks_js__WEBPACK_IMPORTED_MODULE_3__.sortTasksByName)(tasks, order)
            break;
    }
...
/* harmony import */ var _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProjectClass.js */ "./src/ProjectClass.js");
/* harmony import */ var _TaskClass__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TaskClass */ "./src/TaskClass.js");
/* harmony import */ var _add_task_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-task.js */ "./src/add-task.js");
/* harmony import */ var _add_project_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add-project.js */ "./src/add-project.js");
/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./display.js */ "./src/display.js");
...
function loadLocalStorage() {
    ...
    _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.projects = []
    ...
    for (let i = 0; i < projects.length; i++) {
        ...
        for (let j = 0; j < rawTasks.length; j++) {
            ...
            let task = new _TaskClass__WEBPACK_IMPORTED_MODULE_2__.Task(
                rawTasks[j]._title,
                rawTasks[j]._dueDate,
        ...
        let project = new _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.Project(projects[i].name, constructedTasks, projects[i].active) 

        // save to ProjectList.projects
        _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.add(project)

    }
}

function saveToLocalStorage() {
    localStorage['projects'] = JSON.stringify(_ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.projects)
}

// initialize local storage
if (!localStorage['projects']) {
    let inbox = new _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.Project('Inbox', [], true);
    _ProjectClass_js__WEBPACK_IMPORTED_MODULE_1__.ProjectList.add(inbox); 
    saveToLocalStorage()
} 

// initial loading
(0,_display_js__WEBPACK_IMPORTED_MODULE_5__.updateScreen)()

// Add tasks click handler
document.querySelector('.add-task-minimized').addEventListener('click', _add_task_js__WEBPACK_IMPORTED_MODULE_3__.showAddTask)

// Add projects click handlers
document.querySelector('.add-project').addEventListener('click', _add_project_js__WEBPACK_IMPORTED_MODULE_4__.openAddProjectForm)
document.querySelector('.button.cancel-project').addEventListener('click', _add_project_js__WEBPACK_IMPORTED_MODULE_4__.closeAddProjectForm)
document.querySelector('.button.add-project').addEventListener('click', _add_project_js__WEBPACK_IMPORTED_MODULE_4__.addProjectClickHandler)

// View options
document.querySelector('.due-date-view').addEventListener('click', _display_js__WEBPACK_IMPORTED_MODULE_5__.changeDueDateView)
document.querySelector('.order-view').addEventListener('click', _display_js__WEBPACK_IMPORTED_MODULE_5__.changeSortOrder)
document.querySelector('#sort').addEventListener('change', _display_js__WEBPACK_IMPORTED_MODULE_5__.sortTasks)
document.querySelector('.view-completed-tasks').addEventListener('click', _display_js__WEBPACK_IMPORTED_MODULE_5__.toggleCompletedTaskView)
